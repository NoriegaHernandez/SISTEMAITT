...
// // Modificar el type View:
// type View = 'dashboard' | 'students' | 'analysis' | 'import' | 'reports' | 'setup' | 'users' | 'profile' | 'grades' | 'groups';
...
type View = 'dashboard' | 'students' | 'analysis' | 'import' | 'reports' | 'setup' | 'users' | 'groups';
      ...
      default:
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Card: Importar Datos - Solo para docentes y admin */}
            {profile.role !== 'student' && (
              <div 
                className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow cursor-pointer" 
            ...
            {/* Card: Nuevo Registro - Solo para docentes */}
            {profile.role === 'teacher' && (
              <div 
                className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow cursor-pointer" 
